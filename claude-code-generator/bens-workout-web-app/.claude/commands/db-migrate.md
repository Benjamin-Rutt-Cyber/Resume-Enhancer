...
Manage database schema changes for Bens Workout Web App safely and consistently.
...
pg_dump bens-workout-web-app > backup_$(date +%Y%m%d_%H%M%S).sql
...
psql bens-workout-web-app -c "\dt"  # List tables
psql bens-workout-web-app -c "\d users"  # Describe table
...
# Restore if needed
psql bens-workout-web-app < backup_TIMESTAMP.sql
...
Database migrations completed for Bens Workout Web App! 📊
